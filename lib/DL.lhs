...
The function \texttt{checkDistributivity} checks whether a lattice is distributive. Furthermore, law 1 and 2 are equivalent
and so it suffcies to only check law 1:
